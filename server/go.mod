module github.com/hedonicadapter/gopher
...
require (
	...
	github.com/redis-developer/go-redis-entraid v0.0.0-20250519132904-1e25b29e9a07 // indirect
	github.com/redis/go-redis/v9 v9.5.3-0.20250416091253-d0a8c76d8420 // indirect
